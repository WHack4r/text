        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 这里的进行路由跳转之前，需要发请求把购买的产品的信息通过请求的形式通知服务器 -->
    ...
    methods: {
      ...
      async addShopcar(){
        ...
        try {
            ...
            // 2.服务器存储成功---进行路由跳转传递参数(产品的信息)
            //  一些简单的数据skuNum，通过query的形式给路由组件传递过去
            // 产品的信息的数据【比较复杂:skuInfo】，通过会话存储（不持久化，会话结束数据会消失）
